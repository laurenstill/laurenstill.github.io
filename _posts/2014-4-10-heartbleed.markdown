...
---
*An edited version of this post originally appeared in [GovernmentHealthIT][GovHIT], a [HiMSS Media][HiMSS Media] affiliate afer the [CVE-2014-0160][heartbleed] bug was publically disclosed. Also quoted in [FierceHealthIT][FierceHealthIT]'s coverage of the bug by [Dan Bowman][danmail] on April 8, 2014.*   
